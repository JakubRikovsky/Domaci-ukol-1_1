...
// then press Enter. You can now see whitespace characters in your code.
   ...
   public static void ukol1() {
        System.out.println("Hello world!"); // chybí uvozovky a strednik na konci
    }
   ...
   public static void ukol3() {
        int pocetLekci = 10;   // místo string pro cislo pouziji "int"
        System.out.println(pocetLekci);
    }

    public static void ukol4() {
        double cena = 10.0; // carka misto tecky 10.0
        System.out.println(cena);
    }

    public static void ukol5() {
        BigDecimal cena = BigDecimal.ZERO; // Nastavíme do proměnné hodnotu 0 // použiji Bigdecimal s nastaveni ZERO
        // Desetkrát přičteme hodnotu jedna desetina (0,1):
        for (int i = 0; i < 10; i++) {
            cena = cena.add(BigDecimal.valueOf(0.1)); // přenastavím cenu na cenu s Bigdecimal
   ...
   public static void ukol7() {
       int vykonMotoru = 120; // odstraním "" abych měl číslo
        System.out.println("Výkon Motoru je: "+vykonMotoru+" KW. "); // pridám + pro text
    }
